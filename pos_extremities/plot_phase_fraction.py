...
files = ['coupled_FoFo_375_CCEortho.txt',
         # 'coupled_FoFo_375_mu16e3.txt',
         'coupled_FoFo_375_mu20e3.txt',
         'coupled_FoFo_375_mu23e3.txt',
         # 'coupled_FoFo_375_mu25e3.txt',
         'coupled_FoFo_375_mu30e3.txt',
         'coupled_FoFo_375_CCEpara.txt']
...
for fname, label in zip(files, labels):
    coupled = calculate_phase_fractions(fname)
    ax.plot(coupled.t, coupled.fer, label=label)
...
# coupled = calculate_phase_fractions('coupled_FoFo_375_mu30e3.txt')
# bainite = calculate_phase_fractions('bainite_FoFo_375.txt')
